  ...
  return (
    <div className="py-24 bg-[#f0f2e9] mt-8 px-2 lg:px-0">
      <div className="max-w-6xl  text-center m-auto py-16 flex flex-col gap-5">
        <h2 className="text-[16px] lg:text-[20px] open-sans">{props.subtitle}</h2>
        <h1 className="text-[28px] lg:text-[35px] lg:max-w-[50%] leading-[35px] lg:leading-[45px] m-auto">{props.title}</h1>
